"""VoxelMorph: a U-Net predicting a stationary velocity field, integrated to a
diffeomorphic displacement by scaling-and-squaring (the MICCAI'18 / MedIA'19 variant).
...
Paper:   Balakrishnan et al., "An Unsupervised Learning Model for Deformable Medical
         Image Registration", CVPR 2018 (arXiv:1805.04605); Dalca et al., MedIA 2019
         (arXiv:1903.03545)
License: GPL-3.0

Only `unet_core` and `SpatialTransformer` are consumed by the CTCF wrapper; the
diffeomorphic VecInt integration lives in models/VoxelMorph/wrapper.py.
"""
