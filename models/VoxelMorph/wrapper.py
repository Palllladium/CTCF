...
from models.VoxelMorph.model import SpatialTransformer, unet_core
...
class VxmDenseHalf(nn.Module):
    ...
    def forward(
        ...
        if return_features:
            # VxmDense has no decoder features to share with L3; emit a zero placeholder.
            feat = torch.zeros(
                mov_half.shape[0],
                16,
                *self.vol_size,
...
class VxmCascadeL2(VxmDenseHalf):
    ...
    def __init__(self, config):
        ...
        l2_full_res = getattr(config, "l2_full_res", False)
        ...
        super().__init__(
            ...
            int_steps=vxm.int_steps if vxm else 7,
        )
