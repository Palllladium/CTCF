<<<<<<< HEAD
# CTCF
Cycle-TransMorph-CF (CTCF): Transformer-based cascade for unsupervised deformable medical image registration (OASIS Task-3)
=======
# OASIS-CTCF
Файлы для работы:
...
>>>>>>> 3f5ad31 (init: CTCF + TM baseline, cascade, utils, configs)
