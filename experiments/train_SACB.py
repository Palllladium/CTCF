...
class Runner:
    ...
    def train_step(self, batch, epoch):
        ...
        # run_train wraps train_step in fp16 autocast, but SACB's kmeans_gpu clustering
        # breaks under fp16 (Half/Float index_put mismatch) — force fp32 for the whole step.
